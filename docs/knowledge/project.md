...
- The repository is currently asset-focused; no Rojo project file or checked-in Luau source tree was present at the last verification.
...
- `docs/knowledge/` contains the living project knowledge base.
...
- Record confirmed Studio hierarchy and code architecture here once inspected; do not infer them from asset names alone.
